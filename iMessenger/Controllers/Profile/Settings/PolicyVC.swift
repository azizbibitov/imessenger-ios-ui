...
class PolicyVC: UIViewController, ControllerTitle {

    static var title: String { return "Policy Privacy" }
    static var image: String { return "policy" }
    
    override func viewDidLoad() {
        super.viewDidLoad()

        view.backgroundColor = UIColor(named: "colorLightGray")
        navigationItem.title = "Policy Privacy"
    }
